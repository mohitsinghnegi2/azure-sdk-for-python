...
class WorkspaceOperationsBase(ABC):
    ...
    def get(self, workspace_name: Optional[str] = None, **kwargs: Any) -> Optional[Workspace]:
        ...
        print("host_url", v2_service_context["host_url"])
    ...
    def begin_update(
        ...
        **kwargs: Any,
        ...
        # print("WorkspaceOperationsBase::Updates a Azure Machine Learning Workspace.")
        ...
        ip_allowlist = None
        if network_acls:
            # provide backward compatibility to ip_allowlist
        ...
        print("WorkspaceOperationBase:: begin_update in Progress  with Param", update_param)
